<template>
    <div>
      <!-- Utilisateur -->
      <template v-if="currentSection === 'home' || currentSection === 'search' || currentSection === 'live' || currentSection === 'favorites' || currentSection === 'account' || currentSection === 'gifts' || currentSection === 'message' || currentSection === 'participer'">
        <TheHeader />
      ...
      <!-- Animateur -->
      <template v-else-if="currentSection === 'homeAnimateur' || currentSection === 'bigContest' || currentSection === 'messageViewers' || currentSection === 'musicChoices' || currentSection === 'voteStart' || currentSection === 'challengeStart' || currentSection === 'liveInfo'">
        <div id="homeAnimateur-section">
